// Instanciar el objeto JSConfetti para el efecto de confeti
const jsConfetti = new JSConfetti();

// Declaración de variables para los Pokémon elegidos, los ataques, las vidas y las victorias
...
const spanVictoriasJugador = document.getElementById(
  "pokemon-jugador-victorias-container"
);
const spanVictoriasRival = document.getElementById(
  "pokemon-rival-victorias-container"
);

const seleccionarButton = document.getElementById(
...
const seccionSeleccionarPokemon = document.getElementById(
  "seleccionar-pokemon"
);
const jugadorVidasContainer = document.getElementById(
  "jugador-hearts-container"
);
...
// Agregar evento para jugar de nuevo
buttonJugarDeNuevo.addEventListener("click", jugarNuevamente);

// Agregar evento al botón de seleccionar Pokémon para llamar a la función de seleccionarPokemon
seleccionarButton.addEventListener("click", seleccionarPokemon);

// Declaración de variables para almacenar los Pokémon y la carta de Pokémon
let pokemons = [];
let pokemonCard;

// Declaración de variables para los Pokémon ganadores
...
pikachu.ataques.push(
  {
    ...
    daño: "1",
    id: "thunder-shock",
    icon: "./assets/electric-type-removebg-preview.png",
    tipo: "Electric",
    ataqueFunction: ataqueTipo,
  },
  {
    nombre: "Double Team",
    daño: "1",
    id: "double-team",
    icon: "./assets/normal-type-removebg-preview.png",
    tipo: "Normal",
    ataqueFunction: ataqueRapido,
  },
  {
    nombre: "Iron Tail",
    daño: "1",
    id: "iron-tail",
    icon: "./assets/steel-type-removebg-preview.png",
    tipo: "Steel",
    ataqueFunction: ataqueFuerte,
  }
);
...
charmander.ataques.push(
  {
    ...
    daño: "1",
    id: "flamethrower",
    icon: "./assets/fire-type-removebg-preview.png",
    tipo: "Fire",
    ataqueFunction: ataqueTipo,
  },
  {
...
squirtle.ataques.push(
  {
    ...
    daño: "1",
    id: "water-gun",
    icon: "./assets/water-type-removebg-preview.png",
    tipo: "Water",
    ataqueFunction: ataqueTipo,
  },
  {
...
bulbasaur.ataques.push(
  {
    ...
    daño: "1",
    id: "razor-leaf",
    icon: "./assets/grass-type-removebg-preview.png",
    tipo: "Grass",
    ataqueFunction: ataqueTipo,
  },
  {
  ...
  },
  {
    ...
    daño: "1",
    id: "venoshock",
    icon: "./assets/poison-type-removebg-preview.png",
    tipo: "Poison",
    ataqueFunction: ataqueFuerte,
  }
);

// Agregar los Pokémon al array de Pokémon
pokemons.push(pikachu, charmander, squirtle, bulbasaur);

// Crear elementos HTML para mostrar las cartas de Pokémon
...
// Función para mostrar las opciones para seleccionar un Pokémon
...
// Imprime los corazones dependiendo de las vidas de los pokemon
...
function printButtons(pokemon) {
  pokemon.ataques.forEach((ataque) => {
    ...
    if (ataque.icon) {
      ...
      iconImg.classList.add("attack-icon", "swing");
...
// Función para seleccionar un Pokémon y mostrar los ataques disponibles
function seleccionarPokemon() {
  ...
  // Añadir la clase 'selected-pokemon' para resaltar al Pokémon seleccionado
  pokemonJugadorImg.classList.add("selected-pokemon");

  // Verificar qué Pokémon ha sido seleccionado por el jugador y mostrar su información
...
// Función para seleccionar al Pokémon rival
function seleccionarPokemonRival() {
  // Elegir aleatoriamente al Pokémon rival
...
// Funciones para los distintos tipos de ataques
// La lógica esta basada en el juego de piedra, papel y tijera
// ataqueTipo = papel  
// ataqueRapido = tijera
// ataqueFuerte = piedra
function ataqueTipo() {
...
// Función para crear y mostrar el mensaje modal con el resultado del combate
...
// Función para realizar un ataque aleatorio por parte del rival
...
// Función para verificar las vidas restantes de los Pokémon
...
// Función para eliminar un corazón (vida) de un Pokémon
...
// Función para agregar el icono de victoria al contenedor especificado
...
// Función para simular el combate entre los Pokémon
function combate() {
...
// Función para deshabilitar los botones de ataque después de finalizado el combate
...
// Función para crear y mostrar el mensaje final del combate
...
// Función para reiniciar el juego y volver a cargar la página
